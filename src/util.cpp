...
int nAnonymizeINSaNeAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\INSN
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\INSN
    // Mac: ~/Library/Application Support/INSN
    // Unix: ~/.INSN
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "INSN";
#else
    fs::path pathRet;
