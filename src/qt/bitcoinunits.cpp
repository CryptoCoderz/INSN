...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("INSN");
    case mBTC: return QString("mINSN");
    case uBTC: return QString::fromUtf8("μINSN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("INSaNes");
    case mBTC: return QString("Milli-INSaNes (1 / 1,000)");
    case uBTC: return QString("Micro-INSaNes (1 / 1,000,000)");
    default: return QString("???");
    }
}
