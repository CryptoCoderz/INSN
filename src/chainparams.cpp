...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "App Wars, Uber Violates App Store Rules - by Dariusz - Mon, 01 May 2017 00:00:00 GMT";
        ...
        */
        ...
        strDevOpsAddress = "i9ByhsYAV2A9A67MsyjWpEjPx3VCkVCLwr";
