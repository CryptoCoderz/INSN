...
#define STOP_MASTERNODE_PAYMENTS_TESTNET       1520146000  // OFF (NOT TOGGLED)
#define STOP_MASTERNODE_PAYMENTS               1520146000  // OFF (NOT TOGGLED)

#define START_DEVOPS_PAYMENTS_TESTNET          1520146000  // OFF (NOT TOGGLED)
#define START_DEVOPS_PAYMENTS                  1520146000  // OFF (NOT TOGGLED)
